...
export function ShowreelVideo() {
  ...
  if (loading) {
    return (
      <section id="showreel" className="w-full h-screen pt-20 px-6 md:px-12 lg:px-24 bg-[#0a0a0a] snap-start flex items-center justify-center">
  ...
  return (
    <section id="showreel" className="w-full h-screen pt-20 px-6 md:px-12 lg:px-24 bg-[#0a0a0a] snap-start flex items-center">
      <div className="max-w-5xl mx-auto w-full">
        ...
        {/* Video with hover overlay and arrow */}
        <div className="group relative aspect-video w-full rounded-2xl overflow-hidden bg-black shadow-2xl border border-zinc-800 cursor-pointer">
          ...
          {/* Invisible link covering the whole area */}
          <a 
