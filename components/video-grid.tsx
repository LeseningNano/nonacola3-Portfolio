      ...
      <div className="pt-16">
        ...
        <div className="mb-6">
          <button
            ...
            className="w-full h-10 bg-zinc-950 hover:bg-zinc-900 transition-colors duration-300 cursor-pointer group flex items-center justify-between px-6 md:px-12 lg:px-16"
          >
