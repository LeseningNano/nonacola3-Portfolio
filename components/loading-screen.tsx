      ...
      <div className="w-full h-full flex items-center justify-center p-6">
        <div className="w-full max-w-lg space-y-3" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
          ...
          <div className="flex items-center justify-between" style={flicker("0s")}>
            <span className="text-[#e5e5e5] text-lg tracking-wider font-bold">{siteConfig.name.toUpperCase()}</span>
            <span className="text-[#e5e5e5] text-xs animate-pulse">LOADING</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3" style={flicker("0.05s")}>
            ...
            <div className="px-3 py-3">
              <div className="text-[#e5e5e5] text-[8px] tracking-widest mb-2">VER</div>
              <div className="text-[#e5e5e5] text-[8px]">03</div>
            </div>
          </div>

          {/* Description */}
          <div className="border border-neutral-700 px-3 py-3" style={flicker("0.1s")}>
            <div className="flex items-center justify-between">
              <span className="text-[#e5e5e5] text-[10px] tracking-widest">INFO</span>
              <span className="text-[#e5e5e5] text-[11px]">VIDEO PORTFOLIO / {siteConfig.description.toUpperCase()}</span>
            </div>
          </div>

          {/* Progress bar */}
          <div className="border border-neutral-700 px-3 py-3" style={flicker("0.15s")}>
            <div className="flex items-center justify-between mb-2">
              <span className="text-[#e5e5e5] text-[10px] tracking-widest">PROGRESS</span>
              <span className="text-[#e5e5e5] text-[10px]">{Math.min(100, Math.floor(progress))}%</span>
            </div>
            <div className="w-full h-px bg-neutral-800 relative">
              <div
                className="absolute left-0 top-0 h-full bg-[#e5e5e5] transition-all duration-150"
          ...
          <div className="flex items-center justify-between" style={flicker("0.2s")}>
            <span className="text-[#e5e5e5] text-xs animate-pulse">© {new Date().getFullYear()}</span>
            <span className="text-[#e5e5e5] text-xs">MADE WITH LOVE</span>
          </div>
        </div>
      </div>
    </div>
