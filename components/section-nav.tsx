...
export function SectionNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed right-6 md:right-10 lg:right-14 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center gap-6 md:gap-7">
        {/* Vertical line */}
        <div className="absolute top-0 bottom-0 w-px bg-zinc-600/50" />
